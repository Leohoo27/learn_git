...
def test(model, target_test_loader):
    ...
    model.eval()
    test_loss = LossMetrics.AverageMeter()
    correct = 0
...
def train(source_loader, target_train_loader, target_test_loader, model, optimizer, CFG):
    ...
    for e in range(args.epochs):
        ...
        train_loss_clf = LossMetrics.AverageMeter()
        train_loss_transfer = LossMetrics.AverageMeter()
        train_loss_total = LossMetrics.AverageMeter()
        model.train()
