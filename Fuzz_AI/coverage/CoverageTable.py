...
class CoverageTableInit():
    ...
    def init_deepxplore_coverage_table_test(self, model):
        """
        initial DeepXplore coverage table
        :param model: DNN model (AlexNet, VGG)
        :return: 1. model layer dict. 2. each layer name
    ...
    def init_deepxplore_coverage_tables(self, model_1, model_2, model_3):
        ...
        # model_layer_dict_1, model_1_layer_names = self.init_deepxplore_coverage_table_test(model_1)
        # model_layer_dict_2, model_2_layer_names = self.init_deepxplore_coverage_table_test(model_2)
        # model_layer_dict_3, model_3_layer_names = self.init_deepxplore_coverage_table_test(model_3)
