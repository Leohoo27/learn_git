"""usage:
python3 fuzz_adversarial_samples.py --batch_size 32 --model_type 1 --seeds_path ./data/adversarial_seeds/ --output_path ./data/generated_fuzz_samples_with_advGAN/ 
"""
...
def main():
    ...
    for idx, (image, labels) in enumerate(data_loader):
        ...
        if pred_1 != pred_2 and pred_1 != pred_3 and pred_2 != pred_3:
            ...
            image_name = 'already_differ_' + str(idx) + '.jpg'
